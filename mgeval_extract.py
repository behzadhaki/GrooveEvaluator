...
set1 = glob.glob('../post_processing_scripts/gt/*.mid')
set2 = glob.glob('../post_processing_scripts/prediction/*.mid')




parser = ArgumentParser()
parser.add_argument('--set1dir', required=False, type=str, default='../post_processing_scripts/gt',
                    help='Path (absolute) to the first dataset (folder)')
parser.add_argument('--set2dir', required=False, type=str, default='../post_processing_scripts/prediction',
                    help='Path (absolute) to the second dataset (folder)')
parser.add_argument('--outfile', required=False, type=str, default="analysis",
                    help='File (pickle) where the analysis will be stored')

parser.add_argument('--num-bar', required=False, type=int, default=2,
